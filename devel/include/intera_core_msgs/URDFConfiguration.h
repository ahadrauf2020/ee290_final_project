// Generated by gencpp from file intera_core_msgs/URDFConfiguration.msg
// DO NOT EDIT!


#ifndef INTERA_CORE_MSGS_MESSAGE_URDFCONFIGURATION_H
#define INTERA_CORE_MSGS_MESSAGE_URDFCONFIGURATION_H
...
struct URDFConfiguration_
{
  ...
  typedef boost::shared_ptr< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> const> ConstPtr;

}; // struct URDFConfiguration_

typedef ::intera_core_msgs::URDFConfiguration_<std::allocator<void> > URDFConfiguration;

typedef boost::shared_ptr< ::intera_core_msgs::URDFConfiguration > URDFConfigurationPtr;
typedef boost::shared_ptr< ::intera_core_msgs::URDFConfiguration const> URDFConfigurationConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >
{
  static const char* value()
  {
    return "intera_core_msgs/URDFConfiguration";
  }
...
template<class ContainerAllocator>
struct Definition< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::intera_core_msgs::URDFConfiguration_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::URDFConfiguration_<ContainerAllocator>& v)
  {
    s << indent << "time: ";
...
#endif // INTERA_CORE_MSGS_MESSAGE_URDFCONFIGURATION_H
