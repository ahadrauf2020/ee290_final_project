// Generated by gencpp from file intera_core_msgs/CameraControl.msg
// DO NOT EDIT!


#ifndef INTERA_CORE_MSGS_MESSAGE_CAMERACONTROL_H
#define INTERA_CORE_MSGS_MESSAGE_CAMERACONTROL_H
...
struct CameraControl_
{
  ...
  typedef boost::shared_ptr< ::intera_core_msgs::CameraControl_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::intera_core_msgs::CameraControl_<ContainerAllocator> const> ConstPtr;

}; // struct CameraControl_

typedef ::intera_core_msgs::CameraControl_<std::allocator<void> > CameraControl;

typedef boost::shared_ptr< ::intera_core_msgs::CameraControl > CameraControlPtr;
typedef boost::shared_ptr< ::intera_core_msgs::CameraControl const> CameraControlConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::intera_core_msgs::CameraControl_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::intera_core_msgs::CameraControl_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::intera_core_msgs::CameraControl_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::intera_core_msgs::CameraControl_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::intera_core_msgs::CameraControl_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::intera_core_msgs::CameraControl_<ContainerAllocator> >
{
  static const char* value()
  {
    return "intera_core_msgs/CameraControl";
  }
...
template<class ContainerAllocator>
struct Definition< ::intera_core_msgs::CameraControl_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32   id\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::intera_core_msgs::CameraControl_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::intera_core_msgs::CameraControl_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::CameraControl_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // INTERA_CORE_MSGS_MESSAGE_CAMERACONTROL_H
